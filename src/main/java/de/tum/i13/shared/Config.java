...
public class Config {
    ...
    public String cache_strategy;

    @CommandLine.Option(names = "-c", description = "Size of the cache e.g. 100 keys", defaultValue = "1024")
    public int cache_size;

    @CommandLine.Option(names = "-l", description = "Logfile", defaultValue = "echo.log")
    public Path logfile;

    @CommandLine.Option(names = "-m", description = "Metadata Information", defaultValue = "null")
    public String metadata_json;

    @CommandLine.Option(names = "-ll", description = "LogLevel", defaultValue = "INFO")
    public Path logLevel;

    @CommandLine.Option(names = "-h", description = "Displays help", usageHelp = true)
    public boolean usagehelp;
    @CommandLine.Option(names = "-sdc", description = "Strict Data Consistency On/Off")
    public boolean SDConsistency;
